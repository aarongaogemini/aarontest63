...
export const configApi = {
  ...
  getSkills: (): Promise<SkillsData> => {
    return get<SkillsData>("/app-config/skills");
  },

  /**
   * 新增 Skill 技能
   * @param params 包含 name 和 description 的请求参数
   */
  addSkill: (params: CreateSkillParams): Promise<void> => {
    return post<void>("/app-config/skills", params);
  },
  ...
  updateSkillEnabled: (
    ...
    return post<void>(
      `/app-config/skills/${skillId}/enabled`,
      { enabled }
    );
  },
};
