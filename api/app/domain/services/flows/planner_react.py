...
from app.domain.models.app_config import AgentConfig, SkillsConfig
...
class PlannerReActFlow(BaseFlow):
    ...
    def __init__(
            ...
            skills_config: SkillsConfig,  # skills技能配置
            session_id: str,  # 会话id
        ...
        # 3.生成skills技能提示词并注入到Agent的系统提示词中
        skills_prompt = skills_config.get_enabled_skills_prompt()
